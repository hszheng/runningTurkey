...
function stepFun(now, fx) {
  ...
  function calcWidthDist(left1, width1, left2, width2, dist) {
    return Math.abs(left1 + width1 / 2 - (left2 + width2 / 2));
  }
  function calcHeightDist(top1, height1, top2, height2, dist) {
    return Math.abs(top1 + height1 / 2 - (top2 + height2 / 2));
  }
